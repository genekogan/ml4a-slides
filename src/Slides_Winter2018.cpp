...
void ofApp::CTMFestival() {
    ...
    s = slideshow.addSlide("Machine learning in the composer's future toolkit, 15 Feb 2018");
...
void ofApp::WorkshopMicrosoftTheGarage() {
    ...
    s->addText(h3, ofColor(0), " - Applications of deep learning", 0.1, 0.3, 0.8);
    ...
    s->addText(h3, ofColor(0), " - 1980s: Geoff Hinton applies backpropagation to train multiple layer neural nets", 0.1, 0.0, 0.8);
    s->addText(h3, ofColor(0), " - 1998: LeNet + handwritten check detection", 0.1, 0.08, 0.8);
    s->addText(h3, ofColor(0), " - 2006: CIFAR + \"Deep Learning Conspiracy\"", 0.1, 0.16, 0.8);
    s->addText(h3, ofColor(0), " - 2009: Convnet gets SOTA for speech-to-text", 0.1, 0.23, 0.8);
    s->addText(h3, ofColor(0), " - 2010: ImageNet challenge", 0.1, 0.32, 0.7);
    s->addText(h3, ofColor(0), " - 2012: AlexNet gets SOTA for image classification", 0.1, 0.4, 0.7);
    s->addText(h3, ofColor(0), " - 2013: ZFNet + Deep learning investment boom", 0.1, 0.48, 0.7);
    s->addText(h3, ofColor(0), " - 2014(ish): More researchers/students using Theano, Torch, Keras, and others", 0.1, 0.56, 0.7);
    s->addText(h3, ofColor(0), " - 2015: Creative boom from Deepdream, stylenet", 0.1, 0.64, 0.7);
    s->addText(h3, ofColor(0), " - 2016: ResNets, Tensorflow, AlphaGo, research branching", 0.1, 0.72, 0.7);
    s->addText(h3, ofColor(0), " - 2017: Final ImageNet, AlphaZero, OpenMined, safety/security/bias", 0.1, 0.8, 0.7);
...
//--------------------------------------------------------------
void ofApp::SteinerCMU(){
    
    ////////////////////////////////////////////////////////////////////////
    /////////  ABOUT ME
    
    s = slideshow.addSlide("Steiner Lecture in Creative Inquiry @ CMU, 5 Feb 2018");
    s->addText(h2, ofColor(255), "@genekogan", 0.1, 0.3, 0.5);
    s->addText(h2, ofColor(255), "genekogan.com", 0.1, 0.4, 0.5);
    s->addText(h2, ofColor(255), "ml4a.github.io", 0.6, 0.3, 0.5);
    s->addText(h2, ofColor(255), "@ml4a_", 0.6, 0.4, 0.5);
    ...
    s = slideshow.addSlide("Mike Tyka - GAN Faces");
    s->addImage("face", "/Users/gene/bin/misc/stock/mtyka-face.jpg", 0, 0, 0.5, 1);
    s->addImage("face", "/Users/gene/bin/misc/stock/mtyka-face2.jpg", 0.5, 0, 0.5, 1);
    
    s = slideshow.addSlide("Terrapattern");
    s->addText(h4, ofColor(255), "Golan Levin, David Newberry, Kyle McDonald, Irene Alvarado, Aman Tiwari, Manzil Zaheer", 0.01, 0.01, 0.9);
    ...
    s = slideshow.addSlide("Mario Klingemann");
    ...
    s = slideshow.addSlide("David Ha - Neokanji");
    s->addImage("kanji", "/Users/gene/bin/misc/stock/hardmaru_kanji.png", 0, 0, 1, 1);
    s->addText(h4, ofColor(255), "http://blog.otoro.net/2015/12/28/recurrent-net-dreams-up-fake-chinese-characters-in-vector-format-with-tensorflow/", 0.01, 0.9, 0.99);
    
    s = slideshow.addSlide("David Ha - sketch-rnn");
    s->addImage("sr", "/Users/gene/bin/misc/stock/hardmaru-sketchrnn1.png", 0, 0.04, 1, 0.6);
    s->addImage("sr", "/Users/gene/bin/misc/stock/hardmaru-sketchrnn2.png", 0, 0.65, 1, 0.35);
    s->addText(h4, ofColor(255), "https://arxiv.org/abs/1704.03477", 0.01, 0.0, 0.99);
    
    s = slideshow.addSlide("Helena Sarin (@glagolista)");
    s->addImage("helana", "/Users/gene/bin/misc/stock/helena - cyclegan.jpg", 0, 0, 1, 1);
    //s->addImage("helana", "/Users/gene/bin/misc/stock/helena - 2.jpg", 0.755, 0.25, 0.25, 0.75);
    ...
    s = slideshow.addSlide("Robin Sloan - LSTM Sci-fi assistant");
    s->addMovie("LSTM helper", "/Users/gene/bin/misc/stock/robinsloan-lstm-author.mp4", true, 0, 0, 1, 1);
    s->addText(h4, ofColor(255), "https://twitter.com/robinsloan/status/725068953383362560", 0.01, 0.0, 0.99);
    ...
    s = slideshow.addSlide("Tom White - Treachery of ImageNet");
    s->addImage("LSTM helper", "/Users/gene/bin/misc/stock/dribnet-treachery.jpg", 0, 0, 1, 1);
    
    s = slideshow.addSlide("Alex Mordvintsev");
    s->addMovie("mario", "/Users/gene/bin/misc/stock/Alex Mordvintsev - Art - NIPS Creativity Art Submission.mp4", true, 0, 0, 1, 1);
...
void ofApp::WorkshopCMUPix2Pix() {
    
    
    s = slideshow.addSlide("6 Feb 2018, CMU");
    s->addText(h2, ofColor(0), "@genekogan", 0.1, 0.3, 0.5);
    s->addText(h2, ofColor(0), "genekogan.com", 0.1, 0.4, 0.5);
    s->addText(h2, ofColor(0), "ml4a.github.io", 0.6, 0.3, 0.5);
    s->addText(h2, ofColor(0), "@ml4a_", 0.6, 0.4, 0.5);
    ...
    s->addText(h3, ofColor(0), " - how generative models work", 0.1, 0.3, 0.8);
    s->addText(h3, ofColor(0), "Part 2: pix2pix & CycleGAN", 0.1, 0.4, 0.8);
    s->addText(h3, ofColor(0), " - projects & ideas", 0.1, 0.5, 0.8);
    s->addText(h3, ofColor(0), " - implementation options", 0.1, 0.6, 0.8);
    s->addText(h3, ofColor(0), " - tutorial (pre-baked oven)", 0.1, 0.7, 0.8);
    ...
    s = slideshow.addSlide("pix2pix + OpenPose");
    ...
    s = slideshow.addSlide("Repositories");
    s->addText(h4, ofColor(0), "https://github.com/phillipi/pix2pix (the original in torch)", 0.01, 0.1, 0.9);
    s->addText(h4, ofColor(0), "https://github.com/affinelayer/pix2pix-tensorflow", 0.01, 0.2, 0.9);
    s->addText(h4, ofColor(0), "https://github.com/junyanz/CycleGAN", 0.01, 0.3, 0.9);
    s->addText(h4, ofColor(0), "https://github.com/junyanz/pytorch-CycleGAN-and-pix2pix", 0.01, 0.4, 0.9);
    s->addText(h4, ofColor(0), "https://github.com/memo/webcam-pix2pix-tensorflow (+ Gene's FaceTracker fork)", 0.01, 0.5, 0.9);
...
//--------------------------------------------------------------
void ofApp::WorkshopCMULapnorm(){
    
    s = slideshow.addSlide("Neural synthesis / Deepdream @ CMU, 8 Feb 2018");
    s->addText(h2, ofColor(0), "@genekogan", 0.1, 0.3, 0.5);
    s->addText(h2, ofColor(0), "genekogan.com", 0.1, 0.4, 0.5);
    s->addText(h2, ofColor(0), "ml4a.github.io", 0.6, 0.3, 0.5);
    s->addText(h2, ofColor(0), "@ml4a_", 0.6, 0.4, 0.5);
    ...
    s = slideshow.addSlide("Activating features via pixel optimization");
    s->addImage("", "/Users/gene/bin/lapnorm/papers/simonyan-et-al-x12.png", 0.0, 0.08, 1, 0.925);
    s->addText(h4, ofColor(0), "Deep Inside Convolutional Networks: Visualising Image Classification Models and Saliency Maps\nSimonyan et al (https://arxiv.org/abs/1312.6034)", 0.01, 0.0, 1.0);
    
    s = slideshow.addSlide("Activating features via pixel optimization");
    s->addImage("", "/Users/gene/bin/lapnorm/papers/Quoc+V.+Le+Optimal+stimulus+for+face+neuron.jpg", 0.0, 0.08, 1, 0.925);
    s->addText(h4, ofColor(0), "Building high-level features using large scale unsupervised learning\nQuoc Le et al (https://arxiv.org/abs/1112.6209)", 0.01, 0.0, 1.0);
    ...
    s = slideshow.addSlide("\"Image generated by a convolutional neural network\"");
    s->addImage("reddit deepdream post", "/Users/gene/bin/deepdream/reddit.png", 0.0, 0.1, 0.7, 1);
    s->addImage("reddit image", "/Users/gene/bin/deepdream/gods/_slugs.jpg", 0.45, 0, 0.55, 0.4);
    s->addText(h3, ofColor(0), "Mysteriously posted to /r/MachineLearning on June 16, 2015", 0.00, 0.0, 0.38);
    ...
    //    slideshow.addSlide("July 2015")->addImage("cappucinno", "/Users/gene/bin/deepdream/cappucinno/composite_cappucinno2a.png", 0.05, 0.05, 0.9, 0.9);
    ...
    s = slideshow.addSlide("Mixing gradients");
    s->addImage("ns", "/Users/gene/bin/lapnorm/papers/lapnorm-mask-example.jpeg", 0, 0, 1, 0.3);
    s->addImage("ns", "/Users/gene/bin/lapnorm/papers/lapnorm-mask-example-m2.jpeg", 0, 0.35, 1, 0.3);
    s->addImage("ns", "/Users/gene/bin/lapnorm/papers/lapnorm-mask-example-m1.jpeg", 0, 0.7, 1, 0.3);
    ...
    s = slideshow.addSlide("Feedback + masks");
    s->addMovie("class synth", "/Users/gene/bin/lapnorm/_bin/mask_videos/F1-40+J1-42+G1-34+D6-31+G1-62+H1-225_n16_o04_r1.31_1.05,1.50,1.10.mp4", true, 0, 0, 1, 1);
