...
void ofApp::ML4A(){
    ...
    //    s->addMovie("ml4a @ itp 1", "/Users/gene/Teaching/ML4A/classes/itp-S16/screenflows/SHORT_itp1.mp4", true, 0, 0, 0.98 / 3.0, 0.5)->setPositionRandom();
    //    s->addMovie("ml4a @ itp 2", "/Users/gene/Teaching/ML4A/classes/itp-S16/screenflows/SHORT_itp2.mp4", true, 1.01 / 3.0, 0, 0.98 / 3.0, 0.5)->setPositionRandom();
    //    s->addMovie("ml4a @ itp 3", "/Users/gene/Teaching/ML4A/classes/itp-S16/screenflows/SHORT_itp3.mp4", true, 2.02 / 3.0, 0, 0.98 / 3.0, 0.5)->setPositionRandom();
    //    s->addMovie("ml4a @ itp 4", "/Users/gene/Teaching/ML4A/classes/itp-S16/screenflows/SHORT_itp4.mp4", true,  0, 0.5, 0.98 / 3.0, 0.5)->setPositionRandom();
    //    s->addMovie("ml4a @ itp 5", "/Users/gene/Teaching/ML4A/classes/itp-S16/screenflows/SHORT_itp5.mp4", true,  1.01 / 3.0, 0.5, 0.98 / 3.0, 0.5)->setPositionRandom();
    //    s->addMovie("ml4a @ itp 6", "/Users/gene/Teaching/ML4A/classes/itp-S16/screenflows/SHORT_itp6.mp4", true,  2.02 / 3.0, 0.5, 0.98 / 3.0, 0.5)->setPositionRandom();
