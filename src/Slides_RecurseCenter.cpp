...
void ofApp::RecurseCenter() {
    
    s = slideshow.addSlide("I <3 NY");
    ...
    // chris wiggins and hackerschools, mike nielsen, alumni
    // interested in how rc deals with tech education
    // topic is about me, my wayward path
    ...
    s = slideshow.addSlide("Self-help");
    s->addImage("tweet", "/Users/gene/bin/misc/stock/rnn/tweet_hurry.png", 0.15, 0.1, 0.7, 0.6);
    
    s = slideshow.addSlide("Machine relearning (working w/ Jeff Snyder)");
    ...
    s->setBackgroundFunction(this, &ofApp::drawBgBlack);
    s->addMovie("video style", "/Users/gene/bin/alt-ai/cubistmirror_v1.mp4", true, 0, 0, 1, 1);
    ...
    s = slideshow.addSlide("Guides and code");
...
void ofApp::WorkshopRecurseCenter() {
    
    s = slideshow.addSlide("Computer vision for hackers");
    s->addText(h2, ofColor(0), "@genekogan", 0.1, 0.2, 0.5);
    s->addText(h2, ofColor(0), "genekogan.com", 0.1, 0.3, 0.5);
    s->addText(h2, ofColor(0), "ml4a.github.io", 0.6, 0.2, 0.5);
    s->addText(h2, ofColor(0), "@ml4a_", 0.6, 0.3, 0.5);
...
void ofApp::WorkshopRecurseCenterDeepLearning() {
